...
class Episode(Base):
    ...
    def credits(self) -> schemas.Credits:
        ...
        """
        data = self.request(f"tv/{self.tv_id}/season/{self.season_id}/episode/{self.episode_id}/credits")
    ...
    def external_ids(self) -> schemas.ExternalIDs:
        ...
        """
        data = self.request(f"tv/{self.tv_id}/season/{self.season_id}/episode/{self.episode_id}/external_ids")
    ...
    def images(self) -> schemas.Images:
        ...
        """
        data = self.request(f"tv/{self.tv_id}/season/{self.season_id}/episode/{self.episode_id}/images")
    ...
    def translations(self) -> schemas.Translations:
        ...
        """
        data = self.request(f"tv/{self.tv_id}/season/{self.season_id}/episode/{self.episode_id}/translations")
    ...
    def videos(self) -> schemas.Videos:
        ...
        """
        data = self.request(f"tv/{self.tv_id}/season/{self.season_id}/episode/{self.episode_id}/videos")
