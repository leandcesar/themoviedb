...
from themoviedb._routes.async_ import (
    TV,
    Authentication,
    Base,
    Certifications,
...
class aioTMDb(_ClientFactory, Base):
    """aioTMDb class.
...
# Canonical name for new code. ``aioTMDb`` remains fully supported for compatibility.
AsyncTMDbClient = aioTMDb
