...
class Find(Base):
    async def by_imdb(self, imdb_id: str) -> dict:
    ...
    async def by_tvdb(self, tvdb_id: str) -> dict:
    ...
    async def by_freebase_mid(self, freebase_mid: str) -> dict:
    ...
    async def by_freebase(self, freebase_id: str) -> dict:
    ...
    async def by_tvrage(self, tvrage_id: str) -> dict:
    ...
    async def by_facebook(self, facebook_id: str) -> dict:
    ...
    async def by_instagram(self, instagram_id: str) -> dict:
    ...
    async def by_twitter(self, twitter_id: str) -> dict:
