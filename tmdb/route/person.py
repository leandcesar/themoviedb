...
class Person(Base):
    async def details(self, person_id: int, *, append: str = None, image_language: str = "null") -> dict:
    ...
    async def changes(self, person_id: int, *, start_date: str = None, end_date: str = None, page: int = 1) -> dict:
    ...
    async def movie_credits(self, person_id: int) -> dict:
    ...
    async def tv_credits(self, person_id: int) -> dict:
    ...
    async def tagged_images(self, person_id: int, *, page: int = 1) -> dict:
    ...
    async def keywords(self, person_id: int) -> dict:
    ...
    async def translations(self, person_id: int) -> dict:
