...
class Episode(Base):
    ...
    async def changes(self, tv_id: int, season_number: int, episode_number: int, *, start_date: str = None, end_date: str = None, page: int = 1) -> dict:
    ...
    async def credits(self, tv_id: int, season_number: int, episode_number: int) -> dict:
    ...
    async def external_ids(self, tv_id: int, season_number: int, episode_number: int) -> dict:
    ...
    async def images(self, tv_id: int, season_number: int, episode_number: int) -> dict:
    ...
    async def translations(self, tv_id: int, season_number: int, episode_number: int) -> dict:
    ...
    async def videos(self, tv_id: int, season_number: int, episode_number: int) -> dict:
