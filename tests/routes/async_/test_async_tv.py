...
async def test_tv_details(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        tv = await aiotmdb.aioTMDb().tv(tv_id).details()
...
async def test_tv_aggregate_credits(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        aggregate_credits = await aiotmdb.aioTMDb().tv(tv_id).aggregate_credits()
        mocked.assert_called_with(
            "GET",
...
async def test_tv_alternative_titles(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        alternative_titles = await aiotmdb.aioTMDb().tv(tv_id).alternative_titles()
        mocked.assert_called_with(
            "GET",
...
@pytest.mark.asyncio
async def test_tv_content_ratings(get_data, assert_data):
    data = get_data("tv/content_ratings")
    tv_id = 123

    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        content_ratings = await aiotmdb.aioTMDb().tv(tv_id).content_ratings()
        mocked.assert_called_with(
            "GET",
...
async def test_tv_credits(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        credits_ = await aiotmdb.aioTMDb().tv(tv_id).credits()
        mocked.assert_called_with(
            "GET",
...
@pytest.mark.asyncio
async def test_tv_episode_groups(get_data, assert_data):
    data = get_data("tv/episode_groups")
    tv_id = 123

    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        episode_groups = await aiotmdb.aioTMDb().tv(tv_id).episode_groups()
        mocked.assert_called_with(
            "GET",
...
async def test_tv_external_ids(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        external_ids = await aiotmdb.aioTMDb().tv(tv_id).external_ids()
        mocked.assert_called_with(
            "GET",
...
async def test_tv_images(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        images = await aiotmdb.aioTMDb().tv(tv_id).images()
        mocked.assert_called_with(
            "GET",
...
async def test_tv_keywords(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        keywords = await aiotmdb.aioTMDb().tv(tv_id).keywords()
        mocked.assert_called_with(
            "GET",
...
async def test_tv_recommendations(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        recommendations = await aiotmdb.aioTMDb().tv(tv_id).recommendations()
        mocked.assert_called_with(
            "GET",
...
async def test_tv_reviews(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        reviews = await aiotmdb.aioTMDb().tv(tv_id).reviews()
        mocked.assert_called_with(
            "GET",
...
async def test_tv_screened_theatrically(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        screened_theatrically = await aiotmdb.aioTMDb().tv(tv_id).screened_theatrically(page=2)
        mocked.assert_called_with(
            "GET",
...
async def test_tv_similar(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        similar = await aiotmdb.aioTMDb().tv(tv_id).similar()
        mocked.assert_called_with(
            "GET",
...
async def test_tv_translations(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        translations = await aiotmdb.aioTMDb().tv(tv_id).translations()
        mocked.assert_called_with(
            "GET",
...
async def test_tv_videos(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        videos = await aiotmdb.aioTMDb().tv(tv_id).videos()
        mocked.assert_called_with(
            "GET",
...
async def test_tv_watch_providers(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        watch_providers = await aiotmdb.aioTMDb().tv(tv_id).watch_providers()
        mocked.assert_called_with(
            "GET",
...
async def test_tvs_latest(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        tv = await aiotmdb.aioTMDb().tvs().latest()
        mocked.assert_called_with(
            "GET",
...
async def test_tvs_airing_today(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        tvs = await aiotmdb.aioTMDb().tvs().airing_today()
        mocked.assert_called_with(
            "GET",
...
async def test_tvs_on_the_air(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        tvs = await aiotmdb.aioTMDb().tvs().on_the_air()
        mocked.assert_called_with(
            "GET",
...
async def test_tvs_popular(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        tvs = await aiotmdb.aioTMDb().tvs().popular()
        mocked.assert_called_with(
            "GET",
...
async def test_tvs_top_rated(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        tvs = await aiotmdb.aioTMDb().tvs().top_rated()
        mocked.assert_called_with(
            "GET",
