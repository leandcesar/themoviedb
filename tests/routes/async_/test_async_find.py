...
async def test_find_by_imdb(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        ...
        results = await aiotmdb.aioTMDb().find().by_imdb(imdb_id)
...
async def test_find_by_tvdb(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        results = await aiotmdb.aioTMDb().find().by_tvdb(tvdb_id)
        mocked.assert_called_with(
            "GET",
...
async def test_find_by_freebase_mid(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        results = await aiotmdb.aioTMDb().find().by_freebase_mid(freebase_mid)
        mocked.assert_called_with(
            "GET",
...
async def test_find_by_freebase(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        results = await aiotmdb.aioTMDb().find().by_freebase(freebase_id)
        mocked.assert_called_with(
            "GET",
...
async def test_find_by_tvrage(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        results = await aiotmdb.aioTMDb().find().by_tvrage(tvrage_id)
        mocked.assert_called_with(
            "GET",
...
async def test_find_by_facebook(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        results = await aiotmdb.aioTMDb().find().by_facebook(facebook_id)
        mocked.assert_called_with(
            "GET",
...
async def test_find_by_instagram(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        results = await aiotmdb.aioTMDb().find().by_instagram(instagram_id)
        mocked.assert_called_with(
            "GET",
...
async def test_find_by_twitter(get_data, assert_data):
    ...
    with patch("themoviedb._routes.async_._base.ClientSession.request") as mocked:
        mocked.return_value.__aenter__.return_value.json.return_value = data
        results = await aiotmdb.aioTMDb().find().by_twitter(twitter_id)
        mocked.assert_called_with(
            "GET",
